  ...
  return (
    <div className="w-4/5 mx-auto">
      <div className="flex lg:flex-row flex-col justify-center gap-6">
        {/* Work Experience Card 2 - Sleek Space Design */}
        <div className="lg:w-6/12 w-full relative overflow-hidden rounded-xl shadow-2xl border-2 border-gray-700/50 backdrop-blur-sm">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-slate-900/30 to-black/40">
            <div className="absolute inset-0 opacity-20" style={{
              backgroundImage: `radial-gradient(1px 1px at 25% 25%, white, transparent),
          ...
          {/* Blue accent line */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#c7536e] to-transparent"></div>
          
          <div className="relative z-10 p-8">
            {/* Header */}
            <div className="flex items-start justify-between mb-8">
              <div className="flex-1">
                <div className="inline-block px-3 py-1 bg-[#c7536e]/10 border border-[#c7536e]/30 rounded-full mb-3">
                  <span className="text-[#c7536e] text-xs font-semibold uppercase tracking-wider">Spare Time</span>
                </div>
                <h3 className="text-3xl font-bold text-white mb-2">Founder</h3>
                <a href="https://love-builder.com" className="text-xl text-gray-300 underline hover:text-[#c7536e]">Love-Builder.com</a>
              </div>
              <img className="xl:h-16 xl:w-16 w-14 h-14 object-contain opacity-90" src="logo-love-builder.svg" alt="Love-Builder.com" />
            </div>
            ...
            <div className="relative mb-8">
              ...
              <div className="relative flex justify-center">
                <div className="w-2 h-2 bg-[#c7536e] rounded-full"></div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              {[
                'Founded a passion project focused on building a unique dating platform',
                'Led all aspects of product development, from ideation to deployment',
                'Designed and implemented the full stack architecture using modern technologies',
                'Gained hands-on experience in entrepreneurship, product management, and full stack development',
              ].map((item, idx) => (
                <div key={idx} className="flex items-start space-x-3 group">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#c7536e] mt-2 flex-shrink-0 group-hover:scale-125 transition-transform"></div>
          ...
          {/* Subtle glow effect */}
          <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-[#c7536e] rounded-full blur-3xl opacity-10"></div>
        </div>
        {/* Work Experience Card 1 - Sleek Space Design */}
        <div className="lg:w-6/12 w-full relative overflow-hidden rounded-xl shadow-2xl border-2 border-gray-700/50 backdrop-blur-sm">
          {/* Subtle transparent background */}
          <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-slate-900/30 to-black/40">
            <div className="absolute inset-0 opacity-20" style={{
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="flex items-start justify-between mb-8">
              <div className="flex-1">
                ...
                <a href="https://palette.team/" className="text-xl text-gray-300 underline hover:text-red-400">Palette</a>
              </div>
